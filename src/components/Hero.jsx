      ...
      >
        <motion.div className="z-10 max-md:order-last" variants={itemVariants}>
          ...
          <motion.div className="flex gap-5 max-md:justify-center" variants={itemVariants}>
            ...
            <Magnetic className="hover-glow"><a href="https://www.linkedin.com/in/haripriyana677?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=android_app" target="_blank" rel="noopener noreferrer" className="w-12 h-12 rounded-full bg-cardBg flex items-center justify-center text-slate-50 text-xl transition-all duration-300 hover:bg-gradient-to-r hover:from-primary hover:to-secondary hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/30"><FaLinkedin /></a></Magnetic>
            ...
            <Magnetic className="hover-glow"><a href="tel:9787586293" className="w-12 h-12 rounded-full bg-cardBg flex items-center justify-center text-slate-50 text-xl transition-all duration-300 hover:bg-gradient-to-r hover:from-primary hover:to-secondary hover:-translate-y-1 hover:shadow-lg hover:shadow-primary/30"><FaPhone /></a></Magnetic>
          </motion.div>
        </motion.div>
